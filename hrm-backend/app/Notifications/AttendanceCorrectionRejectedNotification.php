...
class AttendanceCorrectionRejectedNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            ...
            'message' => "Your attendance correction request for {$attendanceDate} has been rejected. Remarks: {$this->correction->remarks}",
        ];
    }
}
