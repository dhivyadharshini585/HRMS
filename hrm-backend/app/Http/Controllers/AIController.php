...
class AIController extends Controller
{
    ...
    public function hrAssistant(Request $request)
    {
        ...
        if (preg_match('/\b(INSERT|UPDATE|DELETE|DROP|ALTER|TRUNCATE|GRANT|REVOKE|EXEC|EXECUTE)\b/i', $sqlQuery)) {
        ...
        try {
            // Use the strict read-only database connection
            $results = DB::connection('ai-readonly')->select($sqlQuery);
        } catch (\Exception $e) {
            return response()->json([
